...
public final class HTMLHostManagerServlet extends HostManagerServlet {
     ...
     * @return output
     */
    private String add(HttpServletRequest request, String name,
     ...
     * @return output
     */
    private String remove(String name, StringManager smClient) {
     ...
     * @return output
     */
    private String start(String name, StringManager smClient) {
     ...
     * @return output
     */
    private String stop(String name, StringManager smClient) {
     ...
     * @return output
     */
    private String persist(StringManager smClient) {
